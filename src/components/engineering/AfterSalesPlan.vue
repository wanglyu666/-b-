            ...
            <tr v-for="(item, i) in afterSalesData" :key="i" class="border-b border-white/5 hover:bg-white/5 transition-colors">
              ...
              <td class="px-6 py-4 text-right">
                ...
                <button 
                  ...
                  class="px-4 py-1.5 bg-[#FFC091] text-[#260A2F] text-xs font-bold rounded-full hover:bg-[#ffad70] transition-colors shadow-[0_0_10px_rgba(255,192,145,0.3)] active:scale-95"
                >
                  预约验收时间
                </button>
                <button 
