...
export const billData: Bill[] = [
  {
    ...
    paymentBatch: '第1批',
    currentPaymentBatch: '第1批',
    currentRatio: '100%',
    currentPayNote: '全额请款，按合同节点一次性支付。',
  },
  {
    id: 2,
    status: 'confirm',
    ...
    paymentBatch: '第2批',
    currentPaymentBatch: '第2批',
    currentRatio: '100%',
    currentPayNote: '材料到场验收后请款。',
  },
  {
    id: 3,
    status: 'confirm',
    ...
    paymentBatch: '第3批',
    currentPaymentBatch: '第3批',
    currentRatio: '100%',
    currentPayNote: '施工完成并验收通过后请款。',
  },
  {
    id: 10,
    status: 'confirm',
    ...
    name: '配电室巡检与整改',
    amount: '¥62,000',
    contractNo: 'HT-2024-0010',
    contractAmount: '¥62,000',
    paidAmount: '¥0',
    payRatio: '0%',
    payToAmount: '¥62,000',
    appliedAt: '2026-04-12',
    paymentBatch: '第4批',
    currentPaymentBatch: '第4批',
    currentRatio: '100%',
    currentPayNote: '整改项闭环后请款。',
  },
  {
    id: 11,
    status: 'confirm',
    ...
    name: '地下泵房设备保养',
    amount: '¥19,600',
    contractNo: 'HT-2024-0011',
    contractAmount: '¥19,600',
    paidAmount: '¥0',
    payRatio: '0%',
    payToAmount: '¥19,600',
    appliedAt: '2026-04-11',
    paymentBatch: '第5批',
    currentPaymentBatch: '第5批',
    currentRatio: '100%',
    currentPayNote: '保养报告提交后请款。',
  },
  {
    id: 12,
    status: 'confirm',
    ...
    contractAmount: '¥38,900',
    paidAmount: '¥0',
    payRatio: '0%',
    payToAmount: '¥38,900',
    appliedAt: '2026-04-10',
    paymentBatch: '第6批',
    currentPaymentBatch: '第6批',
    currentRatio: '100%',
    currentPayNote: '系统联调完成后请款。',
  },
  {
    id: 4,
    status: 'pay',
    ...
    currentPaymentBatch: '第2批',
    currentRatio: '68%',
    currentPayNote: '二期修补完成后尾款请款。',
    invoiceType: '增值税专用发票',
    invoiceNo: 'FP202604140001',
    invoiceDate: '2026-04-14',
    amountExTax: '¥35,840',
    amountIncTax: '¥38,000',
    paymentDate: '2026-04-20',
    invoiceRemark: '按合同约定节点支付尾款。',
  },
  {
    id: 5,
    status: 'pay',
    ...
    currentPaymentBatch: '第2批',
    currentRatio: '71%',
    currentPayNote: '设备安装完成后请款。',
    invoiceType: '增值税普通发票',
    invoiceNo: 'FP202604180006',
    invoiceDate: '2026-04-18',
    amountExTax: '¥22,831',
    amountIncTax: '¥24,200',
    paymentDate: '2026-04-22',
    invoiceRemark: '含设备安装与调试费用。',
  },
  {
    id: 6,
    status: 'pay',
    ...
    currentPaymentBatch: '第3批',
    currentRatio: '63%',
    currentPayNote: '本月养护服务结算请款。',
    invoiceType: '增值税普通发票',
    invoiceNo: 'FP202604130018',
    invoiceDate: '2026-04-13',
    amountExTax: '¥9,434',
    amountIncTax: '¥10,000',
    paymentDate: '2026-04-16',
    invoiceRemark: '月度服务费结算。',
  },
  {
    id: 13,
    status: 'pay',
    ...
    name: '公共区域地砖修补',
    amount: '¥12,400',
    contractNo: 'HT-2024-0013',
    contractAmount: '¥12,400',
    paidAmount: '¥4,000',
    payRatio: '32%',
    payToAmount: '¥8,400',
    ...
    currentPaymentBatch: '第2批',
    currentRatio: '68%',
    currentPayNote: '修补完成后请款。',
    invoiceType: '增值税普通发票',
    invoiceNo: 'FP202604090007',
    invoiceDate: '2026-04-09',
    amountExTax: '¥7,925',
    amountIncTax: '¥8,400',
    paymentDate: '2026-04-12',
    invoiceRemark: '含辅材与人工。',
  },
  {
    id: 14,
    status: 'pay',
    ...
    currentPaymentBatch: '第2批',
    currentRatio: '64%',
    currentPayNote: '整理完成后请款。',
    invoiceType: '增值税普通发票',
    invoiceNo: 'FP202604080013',
    invoiceDate: '2026-04-08',
    amountExTax: '¥5,943',
    amountIncTax: '¥6,300',
    paymentDate: '2026-04-11',
    invoiceRemark: '标识材料与施工费。',
  },
  {
    id: 15,
    status: 'pay',
    ...
    name: '空调末端清洗消杀',
    amount: '¥26,500',
    contractNo: 'HT-2024-0015',
    contractAmount: '¥26,500',
    paidAmount: '¥8,000',
    payRatio: '30%',
    payToAmount: '¥18,500',
    ...
    currentPaymentBatch: '第2批',
    currentRatio: '70%',
    currentPayNote: '清洗验收后请款。',
    invoiceType: '增值税专用发票',
    invoiceNo: 'FP202604070021',
    invoiceDate: '2026-04-07',
    amountExTax: '¥17,453',
    amountIncTax: '¥18,500',
    paymentDate: '2026-04-10',
    invoiceRemark: '含消杀药剂与人工。',
  },
  {
    id: 7,
    status: 'paid',
  ...
  },
  {
    ...
    name: '电梯年检配合服务',
    amount: '¥6,800',
    contractNo: 'HT-2024-0016',
    contractAmount: '¥6,800',
    paidAmount: '¥6,800',
    payRatio: '100%',
    payToAmount: '¥0',
  ...
  },
  {
    ...
    name: '楼宇自控点位优化',
    amount: '¥73,200',
    contractNo: 'HT-2024-0017',
    contractAmount: '¥73,200',
    paidAmount: '¥73,200',
    payRatio: '100%',
    payToAmount: '¥0',
  ...
  },
  {
    ...
    name: '园区道路标线翻新',
    amount: '¥18,900',
    contractNo: 'HT-2024-0018',
    contractAmount: '¥18,900',
    paidAmount: '¥18,900',
    payRatio: '100%',
    payToAmount: '¥0',
...
const SETTLEMENT_PROJECT_NAMES = [
  '电梯系统升级',
  '大堂照明改造',
  '机房降噪处理',
  '配电室巡检与整改',
...
function buildSettlementAmount(contract: number, ratio: number): string {
  const n = Math.round(contract * ratio);
  return `¥${n.toLocaleString('zh-CN', { maximumFractionDigits: 0 })}`;
}

function buildSettlementList(): SettlementRecord[] {
  const specs: { status: SettlementStatus; count: number; idStart: number }[] = [
    { status: 'pending_apply', count: 5, idStart: 1 },
    { status: 'under_review', count: 3, idStart: 20 },
    { status: 'pending_upload', count: 8, idStart: 40 },
    { status: 'settled', count: 12, idStart: 100 },
  ];
  const addresses = [
    '北京市朝阳区住邦2000商务中心4号楼5层',
    '上海市浦东新区陆家嘴环路1000号恒生银行大厦15层',
    '深圳市南山区科技园南区深南大道9988号',
    '成都市双流区航空港物流园B区7号库',
  ];
  const rows: SettlementRecord[] = [];
  let seq = 0;
  for (const { status, count, idStart } of specs) {
    for (let i = 0; i < count; i++) {
      seq += 1;
      const id = idStart + i;
      const contractBase = 28000 + (seq % 9) * 12000;
      const contractAmount = buildSettlementAmount(contractBase, 1);
      const settlementRatio =
        status === 'settled' ? 1 : status === 'pending_upload' ? 0.85 : 0.72;
      const settlementAmount = buildSettlementAmount(contractBase, settlementRatio);
      const paidRatio =
        status === 'settled'
          ? 1
          : status === 'pending_upload'
            ? 0.35
            : 0;
      const paidAmount = buildSettlementAmount(contractBase, paidRatio * settlementRatio);
      const contractPrice = buildSettlementAmount(contractBase, 0.88);
      const changeFee = buildSettlementAmount(contractBase, 0.08);
      const deductionFee = buildSettlementAmount(contractBase, 0.04);
      const totalSettlementPrice = settlementAmount;
      const paidProgressAmount = paidAmount;
      const retentionMoney = buildSettlementAmount(contractBase, 0.05);
      rows.push({
        id,
        status,
        no: `ORD-2024${String(300 + seq).padStart(3, '0')}`,
        projectNo: `PRJ-${String(100 + seq).padStart(3, '0')}`,
        name: SETTLEMENT_PROJECT_NAMES[seq % SETTLEMENT_PROJECT_NAMES.length],
        contractAmount,
        settlementAmount,
        paidAmount,
        projectAddress: addresses[seq % addresses.length],
        startDate: `2025-${String((seq % 12) + 1).padStart(2, '0')}-08`,
        completionDate: `2026-${String((seq % 12) + 1).padStart(2, '0')}-15`,
        settlementItems: [
          { category: '合同价款', amount: contractPrice, remark: '按合同约定' },
          { category: '变更费用', amount: changeFee, remark: '现场签证汇总' },
          { category: '减项费用', amount: deductionFee, remark: '未实施项扣减' },
        ],
        ...
        changeItems: [
          {
            orderNo: `CHG-2024${String(100 + seq).padStart(3, '0')}`,
            amount: changeFee,
            remark: '材料规格变更',
          },
        ],
        ...
        ...(status === 'pending_upload' || status === 'settled'
          ? {
              settlementDate: `2026-${String((seq % 12) + 1).padStart(2, '0')}-28`,
            }
          : {}),
      });
    }
...
export const settlementData: SettlementRecord[] = buildSettlementList();
